        ...
        server.on('message', (msg, rinfo) => {
            ...
            switch (messageType) {
                case 'NOTIFY':
                    ...
                    deviceManager.registerDevice(Yeelight.deviceFromInfo(notifyMessage), 'yeelight')
